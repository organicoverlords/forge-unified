...
REQUIRED = {
    ...
    "ui": ["backend-session-controls", "backend-checkpoint-action", "backend-fork-action", "backend-revert-action", "backend-retry-source-action", "/checkpoint", "/fork", "/revert-last-turn", "/retry-source", "backend-session-control-receipt", "copy-session-control-receipt", "forge:session-control", "session-control-event-ledger", "backend-session-control-ledger", "backend-session-control-event-row", "copy-session-control-event", "data-session-control-event", "session-control-event-disclosure", "backend-session-control-event-detail", "show-session-control-event", "aria-expanded", "aria-controls", "session-control-count-summary", "backend-session-control-summary", "backend-session-control-count", "session-control-filter", "session-control-filter-all", "session-control-filter-ok", "session-control-filter-error", "aria-pressed", "session-control-diff-summary", "backend-session-control-diff-summary", "backend-session-control-diff-chip", "session-control-diff-before", "session-control-diff-after", "session-control-diff-removed", "removed_messages"],
    "bundle": ["include_str!(\"chat_ui_session_controls.html\")"],
    "state": ["backend-backed session controls", "checkpoint, fork, revert latest turn, and retry source", "Forge-local session control receipts", "session control event ledger", "copy session control event", "session-control event disclosure", "session-control count summary", "status filters", "session-control diff summary", "before/after/removed message chips", "crates/webui/src/conversation_controls.rs", "crates/webui/src/chat_ui_session_controls.html"],
}
