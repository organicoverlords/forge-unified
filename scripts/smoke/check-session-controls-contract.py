...
REQUIRED = {
    ...
    "ui": ["backend-session-controls", "backend-checkpoint-action", "backend-fork-action", "backend-revert-action", "backend-retry-source-action", "/checkpoint", "/fork", "/revert-last-turn", "/retry-source", "backend-session-control-receipt", "copy-session-control-receipt", "forge:session-control", "session-control-event-ledger", "backend-session-control-ledger", "backend-session-control-event-row", "copy-session-control-event", "data-session-control-event"],
    "bundle": ["include_str!(\"chat_ui_session_controls.html\")"],
    "state": ["backend-backed session controls", "checkpoint, fork, revert latest turn, and retry source", "Forge-local session control receipts", "session control event ledger", "copy session control event", "crates/webui/src/conversation_controls.rs", "crates/webui/src/chat_ui_session_controls.html"],
}
