...
pub async fn tool_catalog(State(_s): State<AppState>) -> Json<serde_json::Value> {
    ...
    Json(serde_json::json!({
        "catalog": "forge_provider_tool_catalog",
        "provider_visible": true,
        "tool_count": tools.len(),
        "names": names,
        "required_tools": ["repo_info", "file_read", "file_write", "file_edit", "file_delete", "apply_patch", "shell_command", "task", "todo_write", "batch_parallel", "browser_proof"],
        "tools": tools
    }))
}
